...
const MovieSearch = () => {
  ...
  const getAllMovies = (search) => {
    const fetchURL = `https://api.themoviedb.org/3/search/movie?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&query=${search}&page=1&include_adult=false`;
      ...
      <div className="flex items-center justify-center bg-black">
        <div className="relative w-full max-w-md mx-4">
          ...
          <svg
            ...
            className="w-6 h-6 absolute top-3 left-3 text-white opacity-50"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
